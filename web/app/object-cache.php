 ...
 * This project is a WordPress object cache backend that implements all available methods in the Memcached PECL extension.
...
if (class_exists('Memcached')) {
    ...
    class WP_Object_Cache
    {
        ...
        public function flush($delay = 0)
        {
            ...
            if ($result && Memcached::RES_SUCCESS === $this->getResultCode()) {
                $this->cache = array();
            }
...
//Detected memcached server - 30/04/2024 18:21:09
define('OC4EVERYONE_PREDEFINED_SERVER', '127.0.0.1:11211');
